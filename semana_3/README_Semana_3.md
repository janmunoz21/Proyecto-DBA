...
- [main.py](../main.py) - menú principal y orquestación.
- [download_manager.py](../download_manager.py) - verificación y descarga de insumos.
- [load_buildings.py](../load_buildings.py) - ingesta y reparación de colecciones.
- [eda_buildings.py](../eda_buildings.py) - auditoría exploratoria y resumen de calidad.

---

## 7. Conclusión

La semana 3 deja implementada la integración de los dos datasets de edificios con control de progreso, filtrado espacial, validación de geometrías e indexación espacial en MongoDB. Esa base ya soporta el análisis geoespacial de la semana 4.
